...
{   [Authorize]
    public class HomeController : Controller
    {
        ...
        {
            var questionModel = _loader.GetDataList("Select question. * from question left join answer on question.question_id = answer.question_id " +
                                                    "group by question.question_id,answer.question_id " +

...
INSERT INTO question(submission_time, view_number, vote_number, question_title, question_message, question_image, question_username,userID,IsAnswered)
VALUES ('2020-02-18 08:02:11', 5, 0, 'Polymorphs', 'I kinda understand what it is, but whats the point? Could you show me some business level example?', null, 'asdasd',1, false);
INSERT INTO question(submission_time, view_number, vote_number, question_title, question_message, question_image, question_username,userID,IsAnswered)
VALUES ('2019-12-24 19:30:12', 42, 0, 'Merry Christmas! But...', 'I dont get how to start the web module so im looking at memes. Any idea?', null, 'xXxmilf_hunter69',2, false);
INSERT INTO question(submission_time, view_number, vote_number, question_title, question_message, question_image, question_username,userID,IsAnswered)
VALUES ('2020-03-05 16:45:17', 3, 0, 'Could you help me with inheritence pls...', 'So I have 2 abstact classes but it errors when i make them parents in a child class', null, 'ninja the gamer',3, false);
INSERT INTO question(submission_time, view_number, vote_number, question_title, question_message, question_image, question_username,userID,IsAnswered)
VALUES ('2020-01-01 02:10:07', 35, 0, 'Happy New Year!', 'I didnt go anywhere to party. Anyone up to have some pairprogramming?', null, 'xXxmilf_hunter69',2, false);
INSERT INTO question(submission_time, view_number, vote_number, question_title, question_message, question_image, question_username,userID,IsAnswered)
VALUES ('2020-03-22 14:55:01', 0, 0, 'Game development?', 'Which language is better and why? Please I want a normal discussion, not arguing!!', null, 'xXxmilf_hunter69',2, false);

INSERT INTO answer(submission_time, vote_number, question_id, answer_message, answer_image, answer_username,userID,IsSolution)
VALUES ('2020-01-02 12:45:03', 8, 5, 'You too, mate. Guess im late to the party thou, i went out and got wasted.', null, 'asdasd',1, false);
INSERT INTO answer(submission_time, vote_number, question_id, answer_message, answer_image, answer_username,userID,IsSolution)
VALUES ('2020-01-02 13:10:33', 3, 5, 'Get well friend', null, 'xXxmilf_hunter69',2, false);
INSERT INTO answer(submission_time, vote_number, question_id, answer_message, answer_image, answer_username,userID,IsSolution)
VALUES ('2019-12-24 20:15:44', 2, 3, 'Its already a good start by wanting to learn at Christmas Eve. Now seriously, spend the upcoming days with your family and we are gonna help you tomorrow!', null, 'ninja the gamer',3, false);
INSERT INTO answer(submission_time, vote_number, question_id, answer_message, answer_image, answer_username,userID,IsSolution)
VALUES ('2020-03-23 07:32:56', 17, 1, 'I would say there is about a 80% similarity, but as time goes on the gap gets wider. C# for Dummies is a nice book, give that a try.', null, 'xXxmilf_hunter69',2, false);
INSERT INTO answer(submission_time, vote_number, question_id, answer_message, answer_image, answer_username,userID,IsSolution)
VALUES ('2020-01-02 12:45:03', 12, 1, 'Original answer is great, i would like to add a little to it: C# seems a bit more modern while Java has more support online!', null, 'asdasd',1, false);
